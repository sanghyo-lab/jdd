...
-- Invoke with a unique synthetic fixture_prefix and stock_quantity. No shared/global reset.
BEGIN;
...
VALUES (:'fixture_prefix' || '-product', :'stock_quantity'::integer, CURRENT_TIMESTAMP);
...
VALUES (:'fixture_prefix' || '-initial', :'fixture_prefix' || '-product', NULL, NULL, NULL,
        'INITIAL', :'stock_quantity'::integer, :'stock_quantity'::integer, CURRENT_TIMESTAMP);
COMMIT;
