...
- 검증: Windows의 Python으로 scripts/check_docs.py 통과(기존 로컬 참고 문서를 포함해 37개 Markdown·271개 링크·8개 JSON 예제), git diff --check 통과. 전체 publish 검증은 별도 main clone에서 이어 수행한다.
