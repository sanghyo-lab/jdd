...
class ReportValidatorTest {
    ...
    @Test void acceptsNormalAndNeedsInputReportsWithoutInventedCauses() {
        assertTrue(validator.validate(report(List.of(), List.of(), List.of()), evidence).isEmpty());
    ...
    @Test void checksSupportLevelsAndLimitations() {
        assertFalse(validator.validate(report(List.of(), List.of(
        ...
        assertTrue(validator.validate(report(List.of(), List.of(
    ...
    @Test void requiresHumanActionsAndObservedSourceTargets() {
        var candidate = new AnalysisReport("1.0", "검토", List.of(), List.of(),
        ...
        assertTrue(validator.validate(report(List.of(), List.of(), List.of(observed)), evidence).isEmpty());
        assertFalse(validator.validate(report(List.of(), List.of(), List.of(observed)), evidence.subList(0, 1)).isEmpty());
    }
